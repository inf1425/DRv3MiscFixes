...
const std::vector<uint8_t> PROLOGUE = {
    ...
    0x48, 0x0f, 0xae, 0x44, 0x24, 0x20        // fxsave64 [rsp + 0x20]
};

const std::vector<uint8_t> EPILOGUE = {
    0x48, 0x0f, 0xae, 0x4c, 0x24, 0x20,       // fxrstor64 [rsp + 0x20]
...
void* findMemory(
    ...
    for (int timesTried = 0; timesTried < 120; timesTried++) {
        ...
        Sleep(500);  // try for 1 minute at most, something probably went wrong if it takes longer
    }
